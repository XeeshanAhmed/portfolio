  ...
  return (
    <div>
        <form action="#" method="post" className='space-y-7 '>
            ...
            <input type="text" id='name' placeholder='Your Name' required className='w-full md:w-[49.5%] border-2 border-neutral rounded-full px-10 py-4 mr-1 focus-within:border-neutral' />
            <label htmlFor="mail" className='hidden'></label>
            <input type="email" id='mail' placeholder='Your Email' required className='w-full md:w-[49.5%] border-2 border-neutral rounded-full px-10 py-4' />
            ...
            <div className='mx-auto sm:mx-0 w-max rounded-full'><Button icon={<GrSend className='text-2xl'/>} >SEND MESSAGE</Button></div>
        </form>
    </div>
  )
}
