    ...
    <div className='md:mx-28 mx-4 my-16'>
        ...
        <div>
            <div className='text-primary  tracking-wider'>
                <p>I am based in <a href={'https://www.google.com/maps?q=Jaranwala, Pakistan'} target='_blank' rel="noopener noreferrer" className='text-base-content border-b border-b-base-content'>Jaranwala, Pakistan</a>.</p>
                <p>I am a Software Engineering undergraduate, persuing a Bachelor&apos;s in Software Engineering from <a href="https://www.nu.edu.pk/" target="_blank" rel="noopener noreferrer" className='text-base-content border-b border-b-base-content'>FAST-NUCES</a>.</p>
            </div>
            <div className='my-16 '>
