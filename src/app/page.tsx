...
const page = () => {
  ...
  return (
    <div className='flex justify-evenly items-center md:flex-row flex-col md:mt-36 mt-14 '>
      <div className='m-6'>
        <Image src={'/profile_img/xeeshan.png'} alt='profile image'  width={350}  height={350} className={`md:border-s-[20px] md:border-b-[20px] border-base-300 md:border-base-content  md:rounded-t-xl md:rounded-b-lg md:rounded-e-xl md:rounded-none rounded-full border-4  md:border-0 `}/>
      </div>
