...
const Page = () => {
  ...
  return (
    <div className='flex justify-evenly items-center md:flex-row flex-col md:mt-36 mt-14 sm:h-[calc(100vh-181px)]' >
      <div className='md:m-6 m-14'>
        <Image src={'/profile_img/xeeshan.png'} alt='profile image' loading='lazy' width={350}  height={350} className='md:border-s-[20px] md:border-b-[20px] border-base-300 md:border-base-content  md:rounded-t-xl md:rounded-b-lg md:rounded-e-xl md:rounded-none rounded-full border-[5px]  md:border-0 '/>
      </div>
      <div className='flex flex-col justify-center items-start md:w-1/2 w-11/12'>
        ...
        /></h1>
        <p className='text-primary my-6 leading-8 md:tracking-wider md:text-left text-center'>I&apos;m a Punjab-based web developer with expertise in both frontend and backend technologies, focused on crafting clean & user-friendly experiences. I am passionate about building excellent software that improves the lives of those around me.
        </p>
